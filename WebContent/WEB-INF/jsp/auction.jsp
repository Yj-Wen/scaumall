			...
			<div class="change">
				...
				<div class="address_detail">
					<div class="left">
						...
						<div class="text">
							<span>收货地址 :</span>
							<span class="address_text">广东省广州市天河区华南农业大学</span>
						</div>
					</div>
					<div class="right">
						<div>
					...
					<div class="left">
						<c:forEach items="${currentCustomer.addressList}" var="address" varStatus="status">
							<div class="choose">
								<div class="text">
									<span>收 货 人 :</span>
									<span class="choose_name_text">${address.addressName }</span>
								</div>
								<input type="hidden" class="addressID" value="${address.addressID }" />
								<div class="second">
									<div class="text">
										<span>联系方式 : </span>
										<span class="choose_phone_text">${address.addressPhone }</span>
									</div>
									<div class="text">
								...
								<div class="text">
									<span>收货地址 :</span>
									<span class="choose_address_text">${address.addressDetail }</span>
								</div>
							</div>
						</c:forEach>
				...
				<table>
					...
					<tbody>
						<c:forEach items="${newindent.indentDetaillist}" var="goods" varStatus="status">
							<tr>
								<td>
									<img src="${goods.good.pictureList[0].picturePath}">
								...
								<td>
									<span>¥</span>
									<span>${goods.good.goodsPrice}</span>
								</td>
