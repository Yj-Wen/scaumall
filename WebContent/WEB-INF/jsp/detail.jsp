...
<body>
	...
	<section class="SE3_product">
		<div>
			...
			<div class="list">
				<ul>
					<c:forEach items="${goods[0].pictureList}" begin="0" end="4" var="picture" varStatus="status">
						<li>
			...
			<div class="detail">
				...
				<div class="detail_price">
					<div>
						...
						<span class="price">
							¥
							<span class="price-num">${goods[0].goodsPrice }</span>
						</span>
					</div>
				...
				<div class="detail_num">
					...
					<div class="num">
						<span class="glyphicon glyphicon-minus"></span>
						<input type="text" class="buy_num" value="1">
						<span class="glyphicon glyphicon-plus"></span>
					</div>
				</div>
		...
		<div class="left">
			...
			<div class="evaluate" data-select="1">
				<div class="evaluate_head">
					...
					<div class="head_right">
						...
						<div class="specify">
							<span class="classify active all_hhh">
								全部（
								<span class="total_evaluate">217</span>
								）
							</span>
							<span class="classify pic_hhh">
								有图（
								<span class="picture_evaluate">16</span>
								）
							</span>
						</div>
					</div>
				...
				<div class="evaluate_detail">
					<ul>
						<c:forEach items="${goods}" var="good" varStatus="status">
							<c:forEach items="${good.evaluateList}" var="evaluate" varStatus="status">
								<li class="evaluate_item">
									...
									<div class="detail_right">
										...
										<div class="specify">
											...
											<span class="specify_text">${good.goodsSpecify }</span>
										</div>
										<div class="text">${evaluate.evaluateContent }</div>
										<div class="evaluate_picture">
											<c:forEach items="${evaluate.evaluatePictureList}" var="picture" varStatus="status">
												<div class="picture1">
			...
			<div class="problem" data-select="2">
				...
				<div>
					...
					<div class="text">华农有货会根据商品所在地、顾客所在地和商品的尺寸重量优选物流配送商，确保优质用户体验。目前暂不支持自选快递。</div>
				</div>
				<br>
				<br>
				<div>
					...
					<div class="text">
						...
						<br>
						5.退换货运费由华农有货承担（大件商品除外）。上门取件费用由华农有货统一与快递服务商结算，顾客只需将退换货商品交给上门取件快递员寄回。如顾客选择自行寄回商品，请先垫付运费，到货验证商品后，华农有货将以现金券形式为用户报销运费，不接受单方面到付件。
					</div>
				</div>
				<br>
				<br>
				<div>
					...
					<div class="text">1.请联系客服并回复“我要开发票”并填写相关信息。开具增值税专用发票需在下单时填写增票资质信息。温馨提示：请确保增票资质信息与贵司税务登记证信息一致，避免因开票信息错误给贵司带来损失。 2.可选开票内容： 依照国税总局开票法规，华农有货订单开具纸质发票、电子发票，开票内容为明细；礼品卡开票内容为预付卡；增值税专用发票开票内容为明细。</div>
				</div>
			</div>
