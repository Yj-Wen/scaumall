$(document).ready(function() {
	...
	$(".SE3_buy .address .change .address_detail .modify").click(function() {
		...
		$(".SE3_buy .goods .re_address .name:first-child span:first-child").text($(".SE3_buy .address .address_detail .name_text").text());
		$(".SE3_buy .goods .re_address .name:first-child span:last-child").text($(".SE3_buy .address .address_detail .phone_text").text());
		$(".SE3_buy .goods .re_address .name:last-child").text($(".SE3_buy .address .address_detail .address_text").text());
	...
	$(".SE3_buy .goods .pay .pay_btn").click(function() {
		if ($(".SE3_buy .goods .re_address .name:first-child span:first-child").text().length > 0) {
			$(location).attr('href', "/SE3-F4/user/pay" + "?addressID=" + $(".SE3_buy .address .address_detail .addressID").val());
		} else {
			$(".tip h4").text("请选择地址");
			$(".tip").fadeIn();
